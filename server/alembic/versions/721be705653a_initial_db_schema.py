...
def upgrade() -> None:
    ...
    op.create_table('recital_sessions',
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_table('recital_audio_segments',
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['recital_session_id'], ['recital_sessions.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_recital_audio_segments_recital_session_id'), 'recital_audio_segments', ['recital_session_id'], unique=False)
    op.create_table('recital_text_segments',
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('recital_session_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(op.f('ix_recital_text_segments_recital_session_id'), 'recital_text_segments', ['recital_session_id'], unique=False)
